...
switch (true) do {
    case (_builder getVariable ["grad_fortifications_surfaceNormal",true]): {
        _l4Txt ctrlSetText localize "$STR_gruppe_adler_fortifications_hint_surfacenormalon";
...
switch (_mode) do {
    case ("COLLIDING"): {
        ...
        _l5Txt ctrlSetText localize "$STR_gruppe_adler_fortifications_hint_collision";
        _l5Pic ctrlSetText (_moduleRoot + "\data\error.paa");
    };

    case ("FLOATING"): {
        _l5BG ctrlSetBackgroundColor [0.65,0.65,0,0.65];
        _l5Txt ctrlSetText localize "$STR_gruppe_adler_fortifications_hint_notonground";
        _l5Pic ctrlSetText (_moduleRoot + "\data\warning.paa");
    };

    case ("ONROAD"): {
        _l5BG ctrlSetBackgroundColor [0.65,0.65,0,0.65];
        _l5Txt ctrlSetText localize "$STR_gruppe_adler_fortifications_hint_noplacementroad";
        _l5Pic ctrlSetText (_moduleRoot + "\data\warning.paa");
    };

    case ("CUSTOM"): {
        _l5BG ctrlSetBackgroundColor [0.65,0.65,0,0.65];
        _conditionHint = [missionConfigFile >> "CfgGradFortifications" >> "Fortifications" >> _fortType >> "conditionHint","text",localize "$STR_gruppe_adler_fortifications_hint_noplacement"] call CBA_fnc_getConfigEntry;
    ...
    case ("CANPLACE"): {
        ...
        _l5Txt ctrlSetText localize "$STR_gruppe_adler_fortifications_hint_canplace";
