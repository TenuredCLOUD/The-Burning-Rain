...
private _emptyPlacement = ([(missionConfigFile >> "CfgGradFortifications" >> "Fortifications"  >> _type >> "emptyWhenPlaced"),"number",0] call CBA_fnc_getConfigEntry) == 1;
...
if (_emptyPlacement) then {
    clearWeaponCargoGlobal _fort;
    clearMagazineCargoGlobal _fort;
    clearItemCargoGlobal _fort;
    clearBackpackCargoGlobal _fort;
};
